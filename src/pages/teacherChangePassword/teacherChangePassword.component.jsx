...
import './teacherChangePassword.style.scss';
import Forminput from '../../components/forminput/forminput.component';
import CustomButton from '../../components/custombutton/custombutton.component';
import bcrypt from 'bcrypt-nodejs';
import { changePasswordT } from '../../firebase/firebase.utils';

class TeacherChangePassword extends Component{
    constructor(props) {
        super(props);
        this.state = {
            email: '',
    ...
    handleSubmit = async event => {
        ...
        if(newPassword===confirmNewPassword){
            bcrypt.hash(newPassword,null,null,function(err,newPassword){
                    changePasswordT(oldPassword,newPassword,email)
                })
        }else{
